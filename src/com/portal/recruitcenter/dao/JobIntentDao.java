...
public abstract interface JobIntentDao
{
  ...
  public abstract JobIntent save(JobIntent paramJobIntent);
  
  public abstract JobIntent updateByUpdater(Updater<JobIntent> paramUpdater);
 ...
 * Qualified Name:     com.portal.recruitcenter.dao.JobIntentDao
