...
/*   2:    */ 
/*   3:    */ import com.portal.extrafunc.entity.MessageType;
/*   4:    */ import com.portal.sysmgr.entity.Site;
/*   5:    */ import java.io.Serializable;
/*   6:    */ 
/*   7:    */ public abstract class BaseMessageType
/*   8:    */   implements Serializable
/*   9:    */ {
/*  10: 17 */   public static String REF = "MessageType";
...
/*  15:    */   
/*  16:    */   public BaseMessageType()
/*  17:    */   {
/*  18: 26 */     initialize();
/*  19:    */   }
/*  20:    */   
/*  21:    */   public BaseMessageType(Integer id)
/*  22:    */   {
/*  23: 33 */     setId(id);
/*  24: 34 */     initialize();
/*  25:    */   }
/*  26:    */   
/*  27:    */   public BaseMessageType(Integer id, Site site, String name, Integer priority)
/*  28:    */   {
/*  29: 46 */     setId(id);
/*  30: 47 */     setSite(site);
/*  31: 48 */     setName(name);
...
/*  88:146 */       return false;
/*  89:    */     }
/*  90:147 */     if (!(obj instanceof MessageType)) {
/*  91:147 */       return false;
/*  92:    */     }
/*  93:149 */     MessageType messageType = (MessageType)obj;
/*  94:150 */     if ((getId() == null) || (messageType.getId() == null)) {
/*  95:150 */       return false;
/*  96:    */     }
/*  97:151 */     return getId().equals(messageType.getId());
/*  98:    */   }
/*  99:    */   
 ...
 * Qualified Name:     com.portal.extrafunc.entity.base.BaseMessageType
