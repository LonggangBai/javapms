...
public abstract interface QuestionnaireDao
{
  ...
  public abstract Questionnaire save(Questionnaire paramQuestionnaire);
  
  public abstract Questionnaire updateByUpdater(Updater<Questionnaire> paramUpdater);
