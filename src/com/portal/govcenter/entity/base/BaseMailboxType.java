...
/*   2:    */ 
/*   3:    */ import com.portal.govcenter.entity.MailboxType;
/*   4:    */ import com.portal.sysmgr.entity.Site;
/*   5:    */ import java.io.Serializable;
/*   6:    */ 
/*   7:    */ public abstract class BaseMailboxType
/*   8:    */   implements Serializable
/*   9:    */ {
/*  10: 17 */   public static String REF = "MailboxType";
...
/*  15:    */   
/*  16:    */   public BaseMailboxType()
/*  17:    */   {
/*  18: 26 */     initialize();
/*  19:    */   }
/*  20:    */   
/*  21:    */   public BaseMailboxType(Integer id)
/*  22:    */   {
/*  23: 33 */     setId(id);
/*  24: 34 */     initialize();
/*  25:    */   }
/*  26:    */   
/*  27:    */   public BaseMailboxType(Integer id, Site site, String name, Integer priority)
/*  28:    */   {
/*  29: 46 */     setId(id);
/*  30: 47 */     setSite(site);
/*  31: 48 */     setName(name);
...
/*  88:146 */       return false;
/*  89:    */     }
/*  90:147 */     if (!(obj instanceof MailboxType)) {
/*  91:147 */       return false;
/*  92:    */     }
/*  93:149 */     MailboxType mailboxType = (MailboxType)obj;
/*  94:150 */     if ((getId() == null) || (mailboxType.getId() == null)) {
/*  95:150 */       return false;
/*  96:    */     }
/*  97:151 */     return getId().equals(mailboxType.getId());
/*  98:    */   }
/*  99:    */   
 ...
 * Qualified Name:     com.portal.govcenter.entity.base.BaseMailboxType
